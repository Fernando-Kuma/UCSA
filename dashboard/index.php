        ...
        <div class="row gx-4">
          <div class="col-auto">
            <div class="avatar avatar-xl position-relative">
              <img src="../img/<?php echo $_SESSION["photo"]; ?>" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-0">
              <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                <li class="nav-item">
                  <a id="profile" class="nav-link mb-0 px-0 py-1 active" data-bs-toggle="tab" href="#" role="tab" aria-selected="true">
                ...
                if ($id == 1) {
                  echo'
                  <li class="nav-item">
                  <a id="users" class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="#" role="tab" aria-selected="false">
                ...
                <li class="nav-item">
                  <a id="settings" class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="#" role="tab" aria-selected="false">
        ...
        <div class="modal-body">
          <form class="mb-3 row" method="POST" id="formUser" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" name="surnames" id="surnames" class="form-control" placeholder="Apellidos">
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
              ...
              <select class="form-select" name="id_rol" id="id_rol">
                <option id="rol" selected>Tipo de rol</option>
                <?php
                  foreach ($resultado_rol as $fila) {
                     echo "<option value=".$fila['rol_id'].">".$fila['rol_name']."</option>";
                  }
                ?>
              </select>
            </div>
